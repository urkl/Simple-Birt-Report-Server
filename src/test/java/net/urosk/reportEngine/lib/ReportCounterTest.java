...
/**
 * Created by kristan_uros on 22.9.2015.
 */
public class ReportCounterTest extends TestCase {

    public void testOnReportcreated() throws Exception {

        ReportCounter reportCounter = new ReportCounter();

        reportCounter.onReportcreated();

        int c = reportCounter.getReportsCreated();
